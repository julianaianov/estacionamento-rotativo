                ...
                <tbody>
                    <tr>
                        ...
                        <td class="py-4 px-4 border-b border-gray-200 text-right">
                            <a href="{{ route('clientes.edit', 1) }}" class="text-blue-600 hover:text-blue-900 mr-2">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a href="{{ route('clientes.show', 1) }}" class="text-green-600 hover:text-green-900 mr-2">
                                <i class="fas fa-eye"></i>
                            </a>
                            <form action="{{ route('clientes.destroy', 1) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
